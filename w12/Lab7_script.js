...
var divBox = document.getElementById('colorBox');
var colorButtons = document.getElementById('colorButtons');
var newColor = document.getElementById('addColorForm');
var userInput = document.getElementById('colorInput');
...
function changeColor(event){
  if(event.target.classList.contains('color-btn')){
    ...
    if(event.target.hasAttribute('title')){
      divBox.innerHTML = event.target.title;
    }else{
      divBox.innerHTML = color;
    }
  }
}
